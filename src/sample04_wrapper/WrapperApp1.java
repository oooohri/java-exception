...
public class WrapperApp1 {
	public static void main(String[] args) {
		...
		// 오토박싱
		// 기본자료형값을 Wrapper클래스의 객체타입의 변수에 대입하면 자동으로 해당 타입의 Wrapper객체가 생성되어 대입된다.
		...
		System.out.println(a);	// Boolean에 재정의된 toString()의 반환값이 출력된다.(숫자 X. 문자임)
		System.out.println(b);	// Integer에 재정의된 toString()의 반환값이 출력된다.(숫자 X. 문자임)
