...
//		
//		// 제네릭클래스
//		GenericBox<Object> box1 = new GenericBox<Integer>();// 오류
...
//		test4(new GenericBox<SmartPhone>());
	...
	// GenericBox객체의 타입파라미터가 FaturePhone이거나 FeaturePhone의 상위타입인것만 전달받을 수 있다.
	public static void test4(GenericBox <? super FeaturePhone> box) {
		
	}
	
//	public static void test2(GenericBox<SmartPhone> box) {
//		
//	}
//	public static void test3(GenericBox<FeaturePhone> box) {
//		
//	}
