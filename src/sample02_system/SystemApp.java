...
public class SystemApp {
	public static void main(String[] args) {
		...
		// 유닉스 타임은 1970년 1월 1일 0시 00:00:00부터 현재 시간까지의 시간정보를 1/1000초 단위로 환산한 값이다.
		long unixTime = System.currentTimeMillis();
		System.out.println("유닉스타임 -> " + unixTime);
		
		// getenv(String name) - 지정된 이름의 시스템환경변수값을 반환한다.
		...
		System.out.println("##### 시스템 환경 변수 #####");
	     ...
	     // 줄바꿈문자는 System.lineSeparator()메소드를 실행해도 획득할수 있다.
...
// 1680251622819_홍길동_이력서.hwp
// 1680252311330_홍길동_이력서.hwp